// src/features/auth/components/AuthMinimalHeader.tsx
// Header compartido por las páginas de auth "de un solo formulario"
// (Recover, Reset) — logo + link a login + volver al inicio.
