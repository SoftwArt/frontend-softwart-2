// src/features/auth/legal/politicaPrivacidad.ts
//
...
//
// version_pyp (aceptacion_legal) debe guardar POLITICA_PRIVACIDAD_VERSION
// exactamente — es el string que identifica qué versión aceptó cada cliente.
import {
...
export const POLITICA_PRIVACIDAD_SECCIONES = [
  ...
  },
  {
    ...
    parrafos: [
      ...
      'al aceptar esta política dentro del sistema. La aceptación es un acto voluntario: sin ella no es ' +
      'posible crear una cuenta ni agendar citas a través del portal, ya que tus datos son indispensables ' +
      'para prestar el servicio.',
 
      'Como constancia de esa autorización, y en cumplimiento del artículo 17 de la Ley 1581 de 2012, ' +
      'registramos la fecha y hora de tu aceptación junto con la versión de la política aceptada. Puedes ' +
      'solicitar copia de esta constancia en cualquier momento a través de los canales indicados en la ' +
      'sección 1.',
    ],
  },
  {
  ...
  },
  {
    ...
    parrafos: [
      ...
      '(fecha, hora y versión de la política aceptada), ya que la ley nos obliga a poder demostrar que el ' +
      'tratamiento fue autorizado.',
    ],
  },
  {
