...
import { Plus, Pencil, Trash2, Eye, AlertCircle, Clock } from 'lucide-react'
...
export function ServicesPage() {
  ...
  const resetForm = () => {
    setNombre(''); setDescripcion(''); setDuracionStr(''); setErrors({}); setEditingId(null)
  }
  ...
  const handleSubmit = async (ev: React.FormEvent) => {
    ...
    try {
      ...
      if (editingId) await onEditar(editingId, data)
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {isLoading ? (
        ...
        <EmptyState title="Sin registros" description="No hay tipos de servicio registrados." />
      ) : (
            ...
            <TableBody>
              {servicios.map(s => (
                <TableRow key={s.id_servicio}>
                  ...
                  <TableCell>
                    <Switch checked={s.estado === true} onCheckedChange={() => onToggleEstado(s.id_servicio)} />
                  </TableCell>
                        ...
                        <AlertDialogContent className="bg-card text-card-foreground border-border">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Esta acción es irreversible. Si este tipo de servicio está vinculado a pedidos existentes,
        ...
        <DialogContent className="bg-card text-card-foreground border-border max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              La duración se usa para las notificaciones de la app móvil.
            </DialogDescription>
          </DialogHeader>
